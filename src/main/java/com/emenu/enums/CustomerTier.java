...
public enum CustomerTier {
    BRONZE("Bronze", 0, 100, 1.0),
    SILVER("Silver", 100, 500, 1.05),
    GOLD("Gold", 500, 1000, 1.1),
    PLATINUM("Platinum", 1000, 5000, 1.15),
    VIP("VIP", 5000, Integer.MAX_VALUE, 1.2);
    ...
    CustomerTier(String displayName, int minPoints, int maxPoints, double pointMultiplier) {
