...
DO $$
BEGIN
    -- Check if constraint actually exists before trying to drop
    IF EXISTS (
        ...
        RAISE NOTICE 'Dropped roles_name_check constraint';
    ELSE
        RAISE NOTICE 'roles_name_check constraint does not exist — skipping';
    END IF;
END $$;
